...
describe('Soulbound NFT Minter: TokenAlreadyMinted', () => {
  ...
  before(async () => {
    ...
    nft = await deployUpgradeable('FakeNoSoulboundNft', 'https://neptunemutual.com', owner.address, owner.address)
  ...
  it('must reject with TokenAlreadyMintedError if minted twice.', async () => {
    const [owner] = await ethers.getSigners()
